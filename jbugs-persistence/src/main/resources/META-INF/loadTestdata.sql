...
INSERT INTO USER(USERNAME, FIRSTNAME, LASTNAME, PASSWORD,ACTIVE, EMAIL, LOCKVERSION) VALUES ('Smithj','John','Smith','pass','0', 'john_smith@msggroup.com','1');
INSERT INTO USER(USERNAME, FIRSTNAME, LASTNAME, PASSWORD,ACTIVE, EMAIL, LOCKVERSION) VALUES ('SmithM','Mary','Smith','pass','1', 'mary_smith@msggroup.com','1');
INSERT INTO USER(USERNAME, FIRSTNAME, LASTNAME, PASSWORD,ACTIVE, EMAIL, LOCKVERSION) VALUES ('SmithK','Kitty','Smith','pass','0', 'kitty_smith@msggroup.com','1');
...
INSERT INTO BUG(TITLEBUG, DESCRIPTIONBUG,ASSIGNEDTO_IDUSER,CREATEDBY_IDUSER, VERSION,SEVERITY, STATUS, LOCKVERSION) VALUES ('My bug', 'My bug description', '1','1','1.2.3','LOW','CLOSED','1');
INSERT INTO BUG(TITLEBUG, DESCRIPTIONBUG,ASSIGNEDTO_IDUSER,CREATEDBY_IDUSER, VERSION,SEVERITY, STATUS, LOCKVERSION) VALUES ('My bug 3', 'My bug description', '1','1','1.2.3','HIGH','OPEN','1');
INSERT INTO BUG(TITLEBUG, DESCRIPTIONBUG,ASSIGNEDTO_IDUSER,CREATEDBY_IDUSER, VERSION,SEVERITY, STATUS, LOCKVERSION) VALUES ('My bug 3', 'My bug description', '1','1','1.2.3','HIGH','OPEN','1');
INSERT INTO BUG(TITLEBUG, DESCRIPTIONBUG,ASSIGNEDTO_IDUSER,CREATEDBY_IDUSER, VERSION,SEVERITY, STATUS, LOCKVERSION) VALUES ('My bug 3', 'My bug description', '1','1','1.2.3','HIGH','OPEN','1');
